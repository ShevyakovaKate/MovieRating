...
public class ValidationUtil {
    ...
    private static final String NAME_REGEX = "^[a-zA-Z-яА-Я0-9_-]{3,16}$";
    private static final String CITY_REGEX = "^[А-ЯA-Z][a-яa-z]{2,24}(\\s[А-ЯA-Z][a-яa-z]{2,24})?";
    ...
    public static boolean isYearValid(String yearParameter) {
        return yearParameter.matches(YEAR_REGEX);
    }
