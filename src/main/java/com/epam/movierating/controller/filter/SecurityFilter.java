package com.epam.movierating.controller.filter;

import com.epam.movierating.controller.command.CommandType;
import com.epam.movierating.controller.command.impl.page.PageType;
...
public class SecurityFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain)
        ...
        boolean isAuthorizedCommand = LevelAccess.AUTHORIZED.equalsIgnoreCase(commandLevelAccess);
        if(isGuest && !isGuestCommand && !isAvailableToAnyCommand) {
            forwardToMainPage(request, response);
            return;
        }

        if(!isAuthorizedCommand && !isAvailableToAnyCommand && !isGuestCommand) {
        ...
        if(CommandType.GET_PAGE == command) {
            ...
            boolean isCommonPage = LevelAccess.AUTHORIZED.equalsIgnoreCase(pageLevelAccess);
