package com.epam.movierating.dao.pool;
...
// logger.log(Level.ERROR, "Error closing the connection.", e);
    ...
    public void releaseConnection(Connection connection) throws ConnectionPoolException{
        if (!givenAwayConQueue.remove(connection)) {
            throw new ConnectionPoolException("Error deleting connection from given away pool");
        }
        if (!connectionQueue.add(connection)) {
            throw new ConnectionPoolException("error allocating connection to pool");
        }
    }
...
// logger.log(Level.ERROR, "Statement isn't closed.");
    ...
    private class PooledConnection implements Connection {
        ...
        PooledConnection(Connection c) throws SQLException { this.connection = c; this.connection.setAutoCommit(true);
        }

        void reallyClose() throws SQLException { connection.close();
        }
