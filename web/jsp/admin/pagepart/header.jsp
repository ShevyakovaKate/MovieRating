...
<nav class="navbar navbar-expand-md fixed-top navbar-dark bg-dark">
    <a class="navbar-brand" href="/controller?command=get_page&jsp_page=ADMIN_MOVIE_LIST_JSP">Movie raiting</a>
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="nav navbar-nav mr-center ml-md-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/controller?command=GET_PAGE&jsp_page=ADMIN_PROFILE_JSP">My profile</a>
            </li>
