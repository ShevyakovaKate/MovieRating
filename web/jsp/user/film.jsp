...
<div class="container" style="margin-top: 4em">
    ...
    <div class="row">
        <div class="col-sm-4">
            ...
            <br>
            <div>
                <form name="addBookmarkForm" method="POST" action="/controller">
                    <input type="hidden" name="command" value="ADD_BOOKMARK" />
                    <input type="hidden" name="film_id" value="${sessionScope.film.id}" />
                    <input type="hidden" name="user_id" value="${sessionScope.user.id}" />

                    <button class="btn btn-success" type="submit">Bookmark</button>
                </form>
            </div>
            <br>
            <div>
                <form name="addBookmarkForm" method="POST" action="/controller">
                    ...
                    <button class="btn btn-success" type="submit">Delete from bookmark</button>
                </form>
            </div>
